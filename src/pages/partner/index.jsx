...
import { ProductCarousal, RestaurantNavBar } from "../../component";
  ...
  return (
    <>
      <div className="partner-container">
        ...
        <Workings />
        <div
          className="d-flex align-items-center justify-content-center flex-column restaurant-exits"
          style={{ backgroundColor: "rgb(233, 233, 233)", height: "18rem" }}
        >
          ...
          <div
            className="rounded d-flex p-3"
            style={{ width: "65%", backgroundColor: "white", height: "3.5rem" }}
          >
            <input
            ...
            <input
              ...
              style={{ fontSize: "15px", width: "inherit" }}
            />
          </div>
        </div>
